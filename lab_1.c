/* lab_1.c
 ...
 аргументы имеют вид: X Y или X, где X - вещественное число (температура), Y - буква, обозначающая шкалу
 температур(F, C, K - Фаренгейта, Цельсия, Кельвина, соответственно), регистр не имеет значения.
 ./a.out 17
 ./a.out 17 K   */
